...
const deleteCategoryService = async (id: string): Promise<Category> => {
...
export default { createCategoryService, getAllCategoryService, getSpecificCategoryService, updateCategoryService, deleteCategoryService };
